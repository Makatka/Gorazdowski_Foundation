...
const ArticleItem = ({ children }) => {
  return (
      ...
      <ArticleWrapper>
        <img src={gaming} alt="Stacja Planszówki" />
        <ArticleText>
          <h5>MIEJCE SPOTKAŃ DLA WSZYSTKICH</h5>
          ...
          <p>
            "Stacja Planszowki" powstała w klubie „Niezapominajka”, jaki w budynku dawnej stacji PKP Sanok Miasto, prowadzi Stowarzyszenie im.św.ks. Gorazdowskiego. Pomysł utworzenia klubu wsparli
